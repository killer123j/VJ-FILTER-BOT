...
API_ID = int(environ.get('API_ID', '25895175'))
API_HASH = environ.get('API_HASH', '6e455b91ca68d245e378aeb903afd001')
BOT_TOKEN = environ.get('BOT_TOKEN', "7739354077:AAGuyHzpQIiQBYj2K7wK_zK-4Bt5UkFnrEc")

CHNL_LNK = environ.get('CHNL_LNK', "https://t.me/+BSkLj7TCrZ1kYjZl")
# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://iili.io/3eWtG44.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1728951776').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002248710429').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1728951776')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gogogaming7428:aLmlRWaqhL9c0SuR@cluster0.bk0fzz3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'https://shortner.in')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '8f36a769bfcd1db81d4c28e78d5edde74cef7d7d')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://https://hurt-petronilla-killerxvipp-692e2af5.koyeb.app/")
